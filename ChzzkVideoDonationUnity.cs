...
public class ChzzkVideoDonationUnity : MonoBehaviour
{
    ...
    {
        return url.Split('@')[1]; // 수정: 'string' 대신 'char'를 사용하여 Split 메서드 호출
    }
    ...
    {
        string auth = sessionUrl.Split(new string[] { "auth=" }, StringSplitOptions.None)[1];
        string server = sessionUrl.Split(new string[] { ".nchat" }, StringSplitOptions.None)[0].Substring(12);
